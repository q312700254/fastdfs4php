 ...
 */
 ...
 $file_info = fastdfs_storage_upload_by_filename("/data/wwwroot/test/QQ.png", null, array(), null, $tracker, $storage);
 if ($file_info)
 {
	...
	$prefix_name = '.part1';
	$slave_file_info = fastdfs_storage_upload_slave_by_filename("/data/wwwroot/test/QQ.png", 
 ...
 $file_id = fastdfs_storage_upload_by_filename1("/data/wwwroot/test/QQ.png", null, array('width'=>1024, 'height'=>800, 'font'=>'Aris', 'Homepage' => true, 'price' => 103.75, 'status' => FDFS_STORAGE_STATUS_ACTIVE), '', $tracker, $storage);
 if ($file_id)
 {
	$master_file_id = $file_id;
	$prefix_name = '.part2';
	$slave_file_id = fastdfs_storage_upload_slave_by_filename1("/data/wwwroot/test/QQ.png", 
 ...
 $file_info = $fdfs->storage_upload_by_filename("/data/wwwroot/test/QQ.png");
 if ($file_info)
 {
	$group_name = $file_info['group_name'];
	$remote_filename = $file_info['filename'];
	...
	$master_filename = $remote_filename;
	$prefix_name = '.part1';
	$slave_file_info = $fdfs->storage_upload_slave_by_filename("/data/wwwroot/test/QQ.png", 
		$group_name, $master_filename, $prefix_name);
        if ($slave_file_info !== false)
        {
        var_dump($slave_file_info);
 ...
 $file_ext_name = 'c';
 $file_id = $fdfs->storage_upload_by_filename1("/data/wwwroot/test/QQ.png", $file_ext_name, array('width'=>1024, 'height'=>800, 'font'=>'Aris'));
 if ($file_id)
 {
	$master_file_id = $file_id;
	$prefix_name = '.part2';
	$slave_file_id = $fdfs->storage_upload_slave_by_filename1("/data/wwwroot/test/QQ.png", 
		$master_file_id, $prefix_name, $file_ext_name);
	if ($slave_file_id !== false)
	{
	var_dump($slave_file_id);
